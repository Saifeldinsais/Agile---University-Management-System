        ...
        <div className="admin-page">
            ...
            <aside className="admin-sidebar">
                ...
                <nav className="admin-menu">
                    <button className="menu-item" onClick={() => go("/admin/dashboard")}>Dashboard</button>
                    <button className="menu-item" onClick={() => go("/admin/facilities")}>Facilities</button>
                    <button className="menu-item" onClick={() => go("/admin/curriculum")}>Curriculum</button>
                    <button className="menu-item" onClick={() => go("/admin/staff/directory")}>Staff</button>
                    <button className="menu-item" onClick={() => go("/admin/enrollments")}>Enrollments</button>
                    <button className="menu-item active" onClick={() => go("/admin/announcements")}>📢 Announcements</button>
                </nav>
                                    ...
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        <div style={{ display: 'flex', gap: '20px', fontSize: '0.85rem', color: '#6b7280', flexWrap: 'wrap' }}>
                                            ...
                                            {announcement.deadline && (
                                                <span style={{ color: '#ef4444' }}>⏰ Deadline: {formatDate(announcement.deadline)}</span>
                                            )}
                                    ...
                                    <div style={{ display: 'flex', gap: '8px', flexShrink: 0 }}>
                                        <button
                                            ...
                                            style={{
                                                ...
                                                borderRadius: '8px',
                                                cursor: 'pointer',
                                                background: announcement.is_pinned ? '#fef3c7' : '#f3f4f6',
                                                fontSize: '1rem'
                                            }}
                                        >
                                            📌
